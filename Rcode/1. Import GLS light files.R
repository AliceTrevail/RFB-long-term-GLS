...
filepattern <- "*.lux" # data file format (use "*.csv" to import all csv files within filepath folders)
...
na_cols <- c("DateTime", "ID", "Light") #column to check for na's
...
filename_dfout <- paste0(species_code, "_GLSlight_clean")
